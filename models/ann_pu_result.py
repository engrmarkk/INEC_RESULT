...
class AnnPuResult(db.Model):
    __tablename__ = 'announced_pu_results'
    result_id = db.Column(db.Integer, primary_key=True)
    polling_unit_uniqueid = db.Column(db.Integer)
    ...
    def __repr__(self):
        return f"AnnPuResult('{self.result_id}', '{self.polling_unit_uniqueid}', '{self.party_abbreviation}', " \
